                ...
                <div className="SuggestIntro">
                    ...
                    <div className="SuggestSearchContainer">
                        <div className="SuggestSearchInnerWrapper">
                            <textarea className="SuggestSearchInput" rows={2} placeholder="Напиши свой запрос" onChange={(v) => setQuery(v.target.value)}></textarea>
                        </div>
