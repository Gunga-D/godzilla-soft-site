                        ...
                        <div className='AuthModalContainer'>
                            ...
                            <div className='AuthModalAdditionalSection'>
                                ...
                                <div style={{marginTop: '14px', color: '#595959', textAlign: 'left', fontSize: '14px'}}>
                                    При регистрации и входе вы соглашаетесь с <a href='/2025_07_09_service_agreement.pdf' className='AuthModalRule'>правилами пользования сайта</a> и с <a href="/2025_07_06_privacy_security.pdf" className='AuthModalRule'>политикой конфиденциальности</a>. 
                                </div>
                            </div>
                        </div>
                    )}
